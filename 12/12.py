...
class MainWindow:
    def __init__(self, title, size):
        ...
        self.window.iconbitmap("../source/car-favicon.ico")
    ...
    def StartWidget(self):
        ...
        self.loose_password = MyButton("Забыли пароль?", "Arial 12", 140, 350, 150, self, "password")
    ...
    def start_work(self):
        ...
        self.car_list = [
            PhotoImage(file="../source/car1.png"),
            PhotoImage(file="../source/car2.png"),
            PhotoImage(file="../source/car3.png"),
            PhotoImage(file="../source/car4.png"),
            PhotoImage(file="../source/car5.png"),
            PhotoImage(file="../source/car6.png"),
            PhotoImage(file="../source/car7.png"),
            PhotoImage(file="../source/car8.png")
        ]

        self.random_car = random.choice(self.car_list)

        self.servis1_img = PhotoImage(file="../source/s1.png")
        self.servis2_img = PhotoImage(file="../source/s2.png")
        self.servis3_img = PhotoImage(file="../source/s3.png")
        self.servis4_img = PhotoImage(file="../source/s4.png")
    ...
    def move_car(self, event):
        ...
        if 580 <= coords[0] <= 610 and 190 <= coords[1] <= 230 and self.servis_finish == False:
            ...
            self.db.InsertSQL(f"INSERT INTO work_user (id_user, count_avto, sec) VALUES ('{id_user}', '{self.kol_avto}', '{now_time}');")
            self.db.CloseDB()
